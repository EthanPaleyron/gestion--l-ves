        ...
        <table>
            ...
            <tbody>
                ...
                foreach ($stagiaires as $key => $stagiaire) {
                    ...
                    echo '<td><select data-key="' . $key . '" name="id_formations_' . $stagiaire->getId() . '">';
                    ...
                    foreach ($formateurs as $formateur) {
                        ...
                        $echoFormateur = '<input type="checkbox" name="formateurs_' . $stagiaire->getId() . '[]" data-key="' . $key . '" data-metier="' . $formateur->getIdFormation() . '" id="formateur_' . $stagiaire->getId() . '_' . $formateur->getId() . '" value="' . $formateur->getId() . '"';
                        ...
                        if ($dates->getDateDebut() && $dates->getDateFin()) {
                            ...
                            <label for="date_debut_' . $formateur->getId() . '">, date debut :</label><input type="date" name="date_debut_' . $formateur->getId() . '" data-key="' . $key . '" data-metier="' . $formateur->getIdFormation() . '"  id="date_debut_' . $formateur->getId() . '" value="' . $dates->getDateDebut() . '">
                            
                            <label for="date_fin_' . $formateur->getId() . '">, date fin :</label><input type="date" name="date_fin_' . $formateur->getId() . '" data-key="' . $key . '" data-metier="' . $formateur->getIdFormation() . '"  id="date_fin_' . $formateur->getId() . '" value="' . $dates->getDateFin() . '"><br>';
                        } else {
                            $echoFormateur .= ' disabled>
                            <label for="formateur_' . $formateur->getId() . '">' . $formateur->getPrenom() . ' ' . $formateur->getNom() . ' dans la salle ' . $formateur->getSalle() . '</label>

                            <label for="date_debut_' . $formateur->getId() . '">, date debut :</label><input type="date" name="date_debut_' . $formateur->getId() . '" data-key="' . $key . '" data-metier="' . $formateur->getIdFormation() . '"  id="date_debut_' . $formateur->getId() . '" value="' . date("Y-m-d") . '" disabled>
                            
                            <label for="date_fin_' . $formateur->getId() . '">, date fin :</label><input type="date" name="date_fin_' . $formateur->getId() . '" data-key="' . $key . '" data-metier="' . $formateur->getIdFormation() . '"  id="date_fin_' . $formateur->getId() . '" value="' . date("Y-m-d") . '" disabled><br>';
                        }
